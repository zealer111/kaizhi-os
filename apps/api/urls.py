...
urlpatterns = [
    ...
    url('^create_package', teacher.Create_Package.as_view()),
    ...
    url('^merge_branch', teacher.Merge_Branch.as_view()),
    url('^merge_master', teacher.Merge_Master.as_view()),
    url('^apply_merge_branch', teacher.Apply_Merge_Branch.as_view()),
